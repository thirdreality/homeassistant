...
export default {
    ...
    // fromZigbee: [fzLocal.thirdreality_acceleration],
    ota: true,
    // exposes: [e.vibration(), e.battery_low(), e.battery(), e.battery_voltage(), e.x_axis(), e.y_axis(), e.z_axis(), e.angle_axis("Xangle"), e.angle_axis("y_angle"), e.angle_axis("z_angle"),],
	extend: [
