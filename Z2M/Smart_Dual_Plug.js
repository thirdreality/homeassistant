	...
	extend: [
		...
		m.deviceAddCustomCluster("3rDualPlugSpecialcluster", {
            ...
            attributes: {
                ...
                meteringOnlyMode: {name: "meteringOnlyMode", ID: 0x0050, type: 0x20, write: true, max: 0xff},
        ...
        m.deviceAddCustomCluster("genBasic", {
            ...
            ID: 0x0000,
            attributes: {
                redLedBrightness: {name: "redLedBrightness", ID: 0xff01, type: 0x20, manufacturerCode: 0x1407, write: true, min: 0, max: 100},
            },
            commands: {},
            commandsResponse: {},
        }),
